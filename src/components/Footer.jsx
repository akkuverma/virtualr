...
const Footer = () => {
  return (
    <footer className='mt-20 border-t py-10 border-neutral-700'>
        <div className="grid grid-cls-2 lg:grid-cols-3 gap-4">
            <div>
            ...
            <div>
                ...
                <ul className='space-y-2'>{platformLinks.map((platform, index) => (
                    <li key={index} >
            ...
            <div>
                ...
                <ul className='space-y-2'>{communityLinks.map((community, index) => (
                    <li key={index} >
